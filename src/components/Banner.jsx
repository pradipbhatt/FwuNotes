    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 relative w-full h-screen md:h-3/4 lg:h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center z-10">
        <div className="max-w-screen-lg mx-auto p-8 text-white">
          ...
          <div className="mt-8 space-y-4 w-full max-w-md mx-auto md:flex md:space-y-0 md:space-x-4">
            <label className="input input-bordered flex items-center gap-2 bg-white bg-opacity-30 p-2 rounded-md w-full md:w-2/5">
              <svg
              ...
              <input
                type="text"
                className="grow p-2 bg-transparent border-none text-white placeholder-white"
                placeholder="Email"
              />
            </label>
            <button className="bg-orange-500 text-white px-4 py-2 w-full md:w-2/5 rounded-md hover:bg-orange-700 transition duration-300">
              Get Started
            </button>
          </div>
        </div>
