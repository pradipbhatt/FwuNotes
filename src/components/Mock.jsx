...
const years = [2077, 2078, 2079, 2080, 2081];
...
const Mock = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out transform hover:scale-105 mt-8">
        <div className="p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Admission Guidelines</h2>
          <p className="text-gray-600 mb-6">
            Click below to view detailed admission guidelines for Far Western University's Faculty of Engineering.
          </p>
          <Link to={`/Mock5/`}>
            <button 
      ...
      <div className="flex-grow flex justify-center items-center bg-gray-800 p-4 dark:bg-gray-100 mt-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {years.map((year) => (
            <div key={year} className="max-w-sm mx-auto bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out transform hover:scale-105">
