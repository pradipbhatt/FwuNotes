...
// import Footer from '../Footer'; // Uncomment if Footer is implemented
...
const Mock = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out transform hover:scale-105 mt-8 mb-8" data-aos="fade-up">
        <div className="p-6">
      ...
      <div className="flex-grow flex justify-center items-center bg-gray-800 p-4 dark:bg-gray-100 mt-8 mb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {years.map((year, index) => (
            <div key={year} className="max-w-sm mx-auto bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out transform hover:scale-105 mb-8" data-aos="fade-up" data-aos-delay={index * 300}>
      ...
      <div className="flex-grow flex justify-center items-center bg-gray-800 p-4 dark:bg-gray-100 mt-8 mb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {/* Mock Test Card 1 */}
          <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out transform hover:scale-105 mb-8" data-aos="fade-up" data-aos-delay="0">
            <div className="p-6">
          ...
          {/* Mock Test Card 2 */}
          <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out transform hover:scale-105 mb-8" data-aos="fade-up" data-aos-delay="300">
            <div className="p-6">
          ...
          {/* Mock Test Card 3 */}
          <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out transform hover:scale-105 mb-8" data-aos="fade-up" data-aos-delay="600">
            <div className="p-6">
