      ...
      {topPerformers.length > 0 ? (
        topPerformers.map((performer, index) => (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: index * 0.1 }} // Staggered animation for each performer
          >
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-2">
              ...
              <span className="font-semibold text-red-500 dark:text-red-400">{performer.percentage.toFixed(2)}%</span>
            </p>
          </motion.div>
        ))
      ) : (
