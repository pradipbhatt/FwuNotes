...
import { AiFillGoogleCircle } from 'react-icons/ai'; // Correct import for Google icon
        ...
        <div className="modal-box p-8 rounded-lg shadow-xl bg-white dark:bg-gray-900">
          <form onSubmit={handleSubmit(onSubmit)} method="dialog">
            ...
            <div className="space-y-6">
              ...
              <button className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 transition-colors duration-300">
                <AiFillGoogleCircle className="w-5 h-5 text-red-500" /> {/* Updated icon */}
