      ...
      >
        ...
        <div className="flex justify-center mt-8 space-x-4">
          <button
            ...
            className="border-2 border-blue-600 text-blue-600 bg-transparent py-2 px-6 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-300 transition-transform duration-300 ease-in-out shadow-md hover:bg-blue-600 hover:text-white"
          >
            Previous
          </button>
          <button
            onClick={() => handlePageChange(Math.min(currentPage + 1, totalSemesters - 1))}
            className="border-2 border-blue-600 text-blue-600 bg-transparent py-2 px-6 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-300 transition-transform duration-300 ease-in-out shadow-md hover:bg-blue-600 hover:text-white"
          >
            Next
          </button>
